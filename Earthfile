...
release-candidate:
    ...
    BUILD +image --PROJECT_NAME=$PROJECT_NAME --APP_BINARY=$APP_BINARY --ISLANDS_PACKAGE=$ISLANDS_PACKAGE --ISLANDS_WASM=$ISLANDS_WASM --BINARY=$APP_BINARY --REGISTRY=$REGISTRY --TAG=$TAG
...
all:
    ...
    ARG REGISTRY=ghcr.io/purton-tech
    BUILD +checks --PROJECT_NAME=$PROJECT_NAME --ISLANDS_PACKAGE=$ISLANDS_PACKAGE --ISLANDS_WASM=$ISLANDS_WASM
    BUILD +image --PROJECT_NAME=$PROJECT_NAME --APP_BINARY=$APP_BINARY --ISLANDS_PACKAGE=$ISLANDS_PACKAGE --ISLANDS_WASM=$ISLANDS_WASM --BINARY=$APP_BINARY --REGISTRY=$REGISTRY --TAG=latest
